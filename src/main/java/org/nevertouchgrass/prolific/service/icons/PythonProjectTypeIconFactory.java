...
public class PythonProjectTypeIconFactory extends AbstractIconFactory {
    ...
    public StackPane configure() {
        ...
        stackPane.getChildren().add(blueShape);
        ...
        StackPane.setAlignment(blueShape, Pos.CENTER);
        blueShape.setTranslateY(-3);
        blueShape.setTranslateX(-3);
        blueShape.setScaleX(1.5);
        blueShape.setScaleY(1.5);

        SVGPath yellowShape = new SVGPath();
        stackPane.getChildren().add(yellowShape);
        ...
        StackPane.setAlignment(yellowShape, Pos.CENTER);
        yellowShape.setTranslateX(3);
        yellowShape.setTranslateY(3);
        yellowShape.setScaleX(1.5);
        yellowShape.setScaleY(1.5);
        return stackPane;
    }
}
