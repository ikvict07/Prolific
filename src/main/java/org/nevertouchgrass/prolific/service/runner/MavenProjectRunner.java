...
public class MavenProjectRunner extends ConfigurableProjectRunner {
    public MavenProjectRunner(ProcessLogsService processLogsService, MetricsService metricsService, UserSettingsHolder userSettingsHolder, ConfiguratorService configuratorService) {
